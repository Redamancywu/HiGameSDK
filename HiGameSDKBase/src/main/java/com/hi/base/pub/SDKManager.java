...
public class SDKManager {
    ...
    public void showBannerAd(Context context,String posId){
        //显示banner广告
        BannerAdManager bannerAd=new BannerAdManager("banner_pos_id",context);
    ...
    public void showInterstitialAd(Activity context,String posId){
        ...
        InterstitialAdManager inters=new InterstitialAdManager(config.getString("interstitial_pos_id"),context);
